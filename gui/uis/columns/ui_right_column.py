...
class Ui_RightColumn(object):
    ...
    def setupUi(self, RightColumn):
        ...
        self.btn_1_frame.setObjectName("btn_1_frame")
        ...
        self.btn_1_menu_1_layout.setObjectName("btn_1_menu_1_layout")
        self.btn_1_menu_1_layout.setContentsMargins(0, 0, 0, 0)

        self.verticalLayout.addWidget(self.btn_1_frame)

        self.verticalSpacer = QSpacerItem(20, 15, QSizePolicy.Minimum,
                                          QSizePolicy.Maximum)
        ...
        self.scroll_area_1.setStyleSheet(
            "background-color: #2c313c; border-style: none; border-top-left-radius: 8px; border-bottom-left-radius: 8px;"
        )
        ...
        self.btn_2_frame.setObjectName("btn_2_frame")
        ...
        self.btn_1_menu_2_layout.setObjectName("btn_1_menu_2_layout")
        self.btn_1_menu_2_layout.setContentsMargins(0, 0, 0, 0)

        self.verticalLayout_2.addWidget(self.btn_2_frame)

        self.verticalSpacer_2 = QSpacerItem(20, 15, QSizePolicy.Minimum,
                                            QSizePolicy.Maximum)
        ...
        self.scroll_area_2.setStyleSheet(
            "background-color: #2c313c; border-style: none; border-top-right-radius: 8px; border-bottom-right-radius: 8px;"
        )
        ...
        self.filter_data_btn_frame.setObjectName("filter_data_btn_frame")
        ...
        self.filter_data_btn_layout.setObjectName("filter_data_btn_layout")
